            ...
            <div class="col-lg-7 col-md-7 col-pad">
                <div class="detail">
                    ...
                    <div class="row call-email-container contact-container">
                        ...
                        <div class="col-sm-6 p-1"><a class="btn btn-block btn-outline-success mb-1" data-toggle="modal" data-target="{{'#CallModelCenter'.$property->reference}}" aria-label="Call">Call</a></div>
