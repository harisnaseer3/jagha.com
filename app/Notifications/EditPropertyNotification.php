...
class EditPropertyNotification extends Notification
{
    use Queueable;
...
//                'user' => $user,
                ...
                'view_property' => route('properties.show', [
                    ...
                    'property' => $id]),
                'title' => 'Edit Property Notification!!',
                'content1' => "Updated details of Property are pending for verification.",
                'data_title' => $title,
                'data_id' => $id,
                'url' => route('admin-properties-edit', $id),
                'buttonText' => 'Verify & Activate Property',
