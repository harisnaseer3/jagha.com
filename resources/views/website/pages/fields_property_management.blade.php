<div class="card">
    <div class="card-header bg-success text-white text-uppercase">Property Type and Location</div>
    <div class="card-body">
    ...
    <div class="card-header bg-success text-white text-uppercase">Property Details</div>
    <div class="card-body">
    ...
    <div class="card-header bg-success text-white text-uppercase">Client Details</div>
    <div class="card-body">
    ...
    <div class="card-header bg-success text-white text-uppercase">Contact Details</div>
    <div class="card-body">
