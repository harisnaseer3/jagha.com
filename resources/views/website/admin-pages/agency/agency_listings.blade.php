                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="tab-content" id="listings-tabContent">
                                        <div class="pull-right">
                                            <div>{{ Form::open(['route' => ['admin.property.search.id'], 'method' => 'post', 'role' => 'form','class'=>'px-3 nav-link color-555', 'style' => 'max-width:300px;' ,'id'=>'search-property-ref']) }}
                                                <input class="px-3 property-id text-transform" type="text" placeholder="Property ID" name="property_id" id="property_id"
                                                       autocomplete="false" required>
                                                <i class="fa fa-search ml-1"></i>
                                                {{ Form::close() }}
                                            </div>
                                            <a class="btn btn-sm theme-blue text-white mr-5 pull-right" href="{{route('admin-agencies-create')}}">Add New Agency</a>
