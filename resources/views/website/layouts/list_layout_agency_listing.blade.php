                ...
                <div class="detail">
                    ...
                    <div class="row call-email-container contact-container">
                        ...
                        @if($agency->description !='')
                            ...
                            <div class="col-sm-6 p-1"><a class="btn btn-block btn-outline-success mb-1" data-toggle="modal" data-target="{{'#CallModelCenter'.$agency->id}}" aria-label="Call">Call</a>
                            </div>
                        ...
                        @else
                            <div class="col-sm-6 p-1"><a class="btn btn-block btn-outline-success mb-1 btn-call" data-toggle="modal" data-target="{{'#CallModelCenter'.$agency->id}}r"
