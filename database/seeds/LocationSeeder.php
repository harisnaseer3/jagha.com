...
//        }
        ...
        $properties = DB::table('properties')->select('id', 'city_id', 'location_id', 'latitude', 'longitude')->get()->toArray();
//        dd($properties);
        foreach ($properties as $property) {
//            dd($property->latitude);
            $loc = Location::where('id', $property->location_id)->first();
            if ($loc->latitude == null && $loc->longitude == null) {
                $loc->latitude = $property->latitude;
                $loc->longitude = $property->latitude;
                $loc->save();
                print($loc->id.', ');
