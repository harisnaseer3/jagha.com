...
class CreatePropertyCountByLocationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('property_count_by_locations', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE `property_count_by_locations`
    ...
    {
        Schema::dropIfExists('property_count_by_locations');
    }
}
