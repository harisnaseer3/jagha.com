<div class="form-group row">
    <label for="{{ $name }}" class="col-sm-4 col-md-2 col-form-label col-form-label-sm">
        {{ ucwords(str_replace('[]', '',str_replace('_', ' ', $name))) }}
    ...
    <div class="col-sm-8 col-md-5">
        {{ Form::select($name, $list, $selected, array_merge(['class' => 'custom-select custom-select-sm select2 select2-hidden-accessible', 'style' => 'width: 100%;', 'tabindex' => '-1', 'aria-hidden' => 'true', 'aria-describedby' => $name . '-error', 'aria-invalid' => 'false'], $selectAttributes), $optionsAttributes, $optgroupsAttributes) }}
