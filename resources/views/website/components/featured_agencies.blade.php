        ...
        @if( $agency->user_id !== 1 && $agency->logo !== null)
            ...
            <a href="{{route('agents.ads.listing',
                ...
                <img src="{{asset('thumbnails/agency_logos/'.explode('.',$agency->logo)[0].'-100x100'.'.webp')}}" alt="{{strtoupper($agency->title)}}" width="50%" height="50%"
                     class="img-fluid"
                     title="{{strtoupper($agency->title)}}" onerror="this.src={{asset('img/logo/dummy-logo.png')}}">
            </a>
        @else
            <a href="{{route('agents.ads.listing',
                                            [ 'city'=>strtolower(Str::slug($agency->city)),
                ...
                <img src="{{asset('img/logo/dummy-logo.png')}}" alt="{{strtoupper($agency->title)}}" width="50%" height="50%" class="img-fluid" title="{{strtoupper($agency->title)}}">
            </a>
        @endif
