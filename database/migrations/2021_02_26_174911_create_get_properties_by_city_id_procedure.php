...
class CreateGetPropertiesByCityIdProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
//        Schema::create('get_properties_by_city_id_procedure', function (Blueprint $table) {
//            $table->id();
//            $table->softDeletes();
//            $table->timestamps();
//        });
//
//        DB::statement('ALTER TABLE `get_properties_by_city_id_procedure`
...
');
    ...
    {
//        Schema::dropIfExists('get_properties_by_city_id_procedure');
        DB::unprepared('DROP PROCEDURE IF EXISTS getPropertiesByCityId;');
    }
}
