                            ...
                            <div class="row my-4">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            {{ Form::bsText('user_id', null, ['required' => true, 'data-default' => 'Please provide id of agency\'s CEO.']) }}
                                            ...
                                            {{ Form::bsEmail('email', null, ['required' => true, 'data-default' => 'Please provide an e-mail address for your agency. This e-mail can be different from your account e-mail.']) }}
                                            {{ Form::bsText('website', isset($agency->website)? $agency->website : null,['data-default' => 'Please provide your website like www.jagha.com']) }}
