                    ...
                    <div class="foot-widget left relative">
                        ...
                        <div class="foot-soc left relative">
                            ...
                            <div class="color-white mt-2">
                                ...
                                <a class="mr-2" href="https://www.instagram.com/aboutpk1/?igshid=19bpcgb38304h" target="_blank" title="Visit About Pakistan Instagram"><i class="fab fa-instagram"></i>
                                </a>
                                ...
                                @foreach($recent_properties as $key => $footer_property)
                                    ...
                                    @else
                                        <li><a href="{{$footer_property->property_detail_path()}}"
                                               title="{{\Illuminate\Support\Str::limit($footer_property->title, 42, $end='..')}}">
                                                {{\Illuminate\Support\Str::limit($footer_property->title, 42, $end='..')}}
                                            </a>
                                        </li>
                            ...
                            <ul class="blog-widget-list left relative" id="footer-blogs">
                                @foreach($footer_agencies as $key => $agency)
                                    <li><a href="javascript:void(0)"
                                           title="{{\Illuminate\Support\Str::limit($agency->title, 42, $end='..')}}">
                                            {{\Illuminate\Support\Str::limit($agency->title, 42, $end='..')}}
                                        </a>
                                    </li>
                    ...
                    <div class="foot-menu relative">
                        <div class="menu-main-menu-container">
                            <ul id="menu-main-menu-2" class="menu">
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2457 page-font"><a href="/index.php">Home</a></li>
