...
class AgencySearchController extends Controller
{
    public function searchPartner(Request $request)
    {
        ...
        if ($request->input('title') !== null && $city) {
            $name = Agency::where('title', '=', $request->input('title'))->exists();
            if ($name) {
                $limit = '';
                $sort = '';
                ...
                $agencies = (new AgencyController)->_listingFrontend()
                    ->where('agencies.title', '=', $request->input('title'))
                ...
                return (new AgencyController)->index();
            }
        } elseif ($request->has('city') && $city) {
