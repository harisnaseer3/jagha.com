                        ...
                        <div id="collapseListing{{ ucfirst($status) }}" class="collapse {{ $params['status'] === $status ? 'show' : '' }}" aria-labelledby="headingListing{{ ucfirst($status) }}"
                            ...
                            <div class="nav flex-column nav-pills" id="listings-tab" role="tablist" aria-orientation="vertical">
                                ...
                                @else
                                    ...
                                    @if ($status === 'active')
                                            <a class="nav-link side-link-style" href="{{ route('admin.properties.listings', array_merge($route_params, ['purpose' => 'basic_listing'])) }}">Basic Listing
                                            ({{ $counts[$status]['basic'] }})</a>
                                        <a class="nav-link side-link-style" href="{{ route('admin.properties.listings', array_merge($route_params, ['purpose' => 'bronze_listing'])) }}">Bronze Listing
                                            ({{ $counts[$status]['bronze'] }})</a>
                                        <a class="nav-link side-link-style" href="{{ route('admin.properties.listings', array_merge($route_params, ['purpose' => 'silver_listing'])) }}">Silver Listing
                                            ({{ $counts[$status]['silver'] }})</a>
                                        <a class="nav-link side-link-style" href="{{ route('admin.properties.listings', array_merge($route_params, ['purpose' => 'golden_listing'])) }}">Golden Listing
                                            ({{ $counts[$status]['golden'] }})</a>
                                        <a class="nav-link side-link-style" href="{{ route('admin.properties.listings', array_merge($route_params, ['purpose' => 'platinum_listing'])) }}">Platinum Listing
