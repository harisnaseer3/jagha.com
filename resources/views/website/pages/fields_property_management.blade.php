<div class="card">
    ...
    <div class="card-body">
        ...
        @else
            ...
            {{ Form::bsSelect2('location', [], isset($property->location) ? $property->location : old('location'), ['required' => true, 'placeholder' => 'Select location in current city','id' => 'add_location','data-default' => 'Select a location from dropdown  or add new location in the field below.']) }}
