...
class CreatePackageAgencyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('package_agency', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE `package_agency`
    ...
    {
        Schema::dropIfExists('package_agency');
    }
}
