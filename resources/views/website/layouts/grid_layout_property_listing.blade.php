                ...
                <div class="property-thumbnail">
                    <a href="{{$property->property_detail_path()}}" class="property-img" title="{{$property->sub_type}} for {{$property->purpose}}">
                        ...
                        <img class="d-block w-100"
                             src="{{ isset($property->image)? asset('thumbnails/properties/'.explode('.',$property->image)[0].'-450x350.webp'): asset("img/logo/dummy-logo.png")}}" onerror="this.src='http://localhost/img/logo/dummy-logo.png'"
