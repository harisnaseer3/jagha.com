        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="property-box">
                ...
                <div class="row contact-container" style="padding: 0 20px;">
                    ...
                    @endif
                    <div class="col-sm-6 p-1"><button class="btn btn-block btn-call mb-1 call-model-btn" data-toggle="modal" data-target="{{'#CallModel2'.$agency->id}}" aria-label="Call">Call</button>
                    </div>
