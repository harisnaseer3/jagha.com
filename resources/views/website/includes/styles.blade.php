...
{{--<link rel="stylesheet" href="{{asset('website/css/menu.min.css')}}" async defer>--}}
...
{{--<link rel="stylesheet" type="text/css" href="{{asset('website/fonts/flaticon/font/flaticon.min.css')}}" async defer>--}}
