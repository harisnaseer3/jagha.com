                ...
                <div class="detail">
                        ...
                        <div class="pull-right" style="font-size: 1rem">
                            @if(isset($agency->status) & $agency->status === 'verified')
                                <span style="color:green" data-toggle="tooltip" data-placement="top"
                                      title="{{$agency->title}} is our verified partner. To become our trusted partner, simply contact us or call us at +92 51 4862317 OR +92 315 5141959">
                    ...
                    <div class="row call-email-container contact-container">
                        ...
                        @if($agency->user_id !== 1 && $agency->description !='')
                            ...
                            <div class="col-sm-6 p-1"><button class="btn btn-block  mb-1 btn-call call-model-btn" data-toggle="modal" data-target="{{'#CallModelCenter'.$agency->id}}" aria-label="Call">Call</button></div>
                            @if($agency->email !== null)
                            ...
                            @else
                                <div class="col-sm-6 p-1" data-toggle="tooltip" data-placement="top" data-html="true" title="<div>Currently not available</div>">
                                    <button class="btn btn-block  mb-1 btn-email disabled" aria-label="Email">Email</button></div>
                            @endif
                        @endif
                    </div>
                </div>
