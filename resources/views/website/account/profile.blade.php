                        ...
                        <div class="tab-pane fade show active" id="account_profile" role="tabpanel" aria-labelledby="account_profile-tab">
                            <div class="row my-4">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-success text-white text-uppercase">User Profile</div>
                                        <div class="card-body">
                                            ...
                                            {{ Form::bsTel('phone', isset($user->phone)?$user->phone: null, ['required' => true, 'data-default' => 'E.g. +92-51-1234567']) }}
                                            {{ Form::bsTel('cell', isset($user->phone)?$user->cell: null, ['data-default' => 'E.g. +92-300-1234567']) }}
                                            {{ Form::bsTel('fax', isset($user->fax)?$user->fax: null, ['data-default' => 'E.g. +92-21-1234567']) }}
                                            ...
                                            {{ Form::bsTextArea('about_yourself', isset($user->about_yourself)?$user->about_yourself: null,  ['data-default' => 'Please provide information about yourself. You could tell us about your work, your interests, lifestyle, nature and other related information about your personality.']) }}
