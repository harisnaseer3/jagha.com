                        ...
                        <div id="collapseListing{{ ucfirst($status) }}" class="collapse {{ $params['status'] === $status ? 'show' : '' }}" aria-labelledby="headingListing{{ ucfirst($status) }}"
                            ...
                            <div class="nav flex-column nav-pills" id="listings-tab" role="tablist" aria-orientation="vertical">
                                @if (\Illuminate\Support\Facades\Request::segment($listings_segment_index) === 'listings' && $params['status'] === $status)
                                    ...
                                    <a class="nav-link {{ $params['purpose'] === 'sale' ? 'active' : '' }}" id="listings-sale-tab" data-toggle="pill" href="#listings-sale" role="tab"
                                       aria-controls="listings-sale" aria-selected="{{ $params['purpose'] === 'sale' ? 'true' : 'false' }}">For Sale ({{ $counts[$status]['sale'] }})</a>
                                    <a class="nav-link {{ $params['purpose'] === 'rent' ? 'active' : '' }}" id="listings-rent-tab" data-toggle="pill" href="#listings-rent" role="tab"
                                       aria-controls="listings-rent" aria-selected="{{ $params['purpose'] === 'rent' ? 'true' : 'false' }}">For Rent ({{ $counts[$status]['rent'] }})</a>
                                    <a class="nav-link {{ $params['purpose'] === 'wanted' ? 'active' : '' }}" id="listings-wanted-tab" data-toggle="pill" href="#listings-wanted" role="tab"
                                       aria-controls="listings-wanted" aria-selected="{{ $params['purpose'] === 'wanted' ? 'true' : 'false' }}">Wanted ({{ $counts[$status]['wanted'] }})</a>
                                    @if ($status === 'active')
                                        <a class="nav-link {{ $params['purpose'] === 'super_hot_listing' ? 'active' : '' }}" id="listings-super_hot-tab" data-toggle="pill" href="#listings-super_hot"
                                        ...
                                        <a class="nav-link {{ $params['purpose'] === 'hot_listing' ? 'active' : '' }}" id="listings-hot-tab" data-toggle="pill" href="#listings-hot" role="tab"
                                           aria-controls="listings-hot" aria-selected="{{ $params['purpose'] === 'hot' ? 'true' : 'false' }}">Hot Listing ({{ $counts[$status]['hot'] }})</a>
                                        <a class="nav-link {{ $params['purpose'] === 'magazine_listing' ? 'active' : '' }}" id="listings-magazine-tab" data-toggle="pill" href="#listings-magazine"
                                ...
                                @else
                                    ...
                                    <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'all'])) }}">All Listings</a>
                                    <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'sale'])) }}">For Sale ({{ $counts[$status]['sale'] }})</a>
                                    <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'rent'])) }}">For Rent ({{ $counts[$status]['rent'] }})</a>
                                    <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'wanted'])) }}">Wanted ({{ $counts[$status]['wanted'] }})</a>
                                    @if ($status === 'active')
                                        <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'super_hot_listing'])) }}">Super Hot Listing
                                            ({{ $counts[$status]['super_hot'] }})</a>
                                        <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'hot_listing'])) }}">Hot Listing
                                            ({{ $counts[$status]['hot'] }})</a>
                                        <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'magazine_listing'])) }}">Magazine Listing
                                            ({{ $counts[$status]['magazine'] }})</a>
                                    @endif
                                @endif
                            </div>
                    ...
                    <div id="collapseListingRejectedImages" class="collapse {{ $params['status'] === 'rejected_images' ? 'show' : '' }}" aria-labelledby="headingListingRejectedImages"
                        ...
                        <div class="nav flex-column nav-pills" id="listings-tab" role="tablist" aria-orientation="vertical">
                            ...
                            @else
                                ...
                                <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'all'])) }}">All Listings</a>
                                <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'sale'])) }}">For Sale (0)</a>
                                <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'rent'])) }}">For Rent (0)</a>
                                <a class="nav-link" href="{{ route('properties.listings', array_merge($route_params, ['purpose' => 'wanted'])) }}">Wanted (0)</a>
                            @endif
                        </div>
                    </div>
