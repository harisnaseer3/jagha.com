                                    ...
                                    <tr>
                                        <td style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%; max-width: 60%;margin: 0 auto;padding: 2em;">
                                            ...
                                            @if($is_expired == 1)
                                                ...
                                                Your {{ucwords($package->type)}} package has been expired.
                                                Package Details are:
                                            ...
                                            @elseif($is_expired == 2)
                                                <span class="position" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: dimgrey;">
                                                Your {{ucwords($package->type)}} package expiry is today. But we've noticed that you didn't use this package,
                                                    So an extension is added to your package. So HURRY UP! Add properties in the package and Enjoy.
                                                ...
                                                <br>
                                                <br>
                                                @if(isset($package->status) && $package->status =='active')
                                            ...
                                            @elseif($is_expired == 3)
                                                <span class="position" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: dimgrey;">
                                                Your {{ucwords($package->type)}} package will expiry in a week. Add Properties in you package.
                                                Package Details are:
                                                <span style="font-weight: bold;">Package Type:  {{ucwords($package->type)}}</span> and
                                                <span style="font-weight: bold;">Package For: {{ucwords($package->package_for)}}</span>
                                                @if($package->package_for =='agency')
