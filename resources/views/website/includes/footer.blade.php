                                ...
                                @foreach($recent_properties as $key => $footer_property)
                                    ...
                                    @else
                                        <li><a href="{{$footer_property->property_detail_path()}}"
                                               ...
                                               {{\Illuminate\Support\Str::limit($footer_property->city, 30, $end='..')}} |
                                                {{\Illuminate\Support\Str::limit(str_replace($footer_property->city,'',$footer_property->title), 40, $end='..')}} |
                                                PKR {{ Helper::getPriceInWords($footer_property->price)}}
                                            </a>
                                        </li>
                                    @endif
                                @endforeach
